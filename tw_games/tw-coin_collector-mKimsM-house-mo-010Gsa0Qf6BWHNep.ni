...
The cookery part 0 is some text that varies. The cookery part 0 is "You are in a cookery. A standard one. Okay, just remember what you're here to do, and everything will go great.
...
Test quest0_0 with "go east / go south / go south / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, attempt to travel east. With that over with, make an effort to go to the south. Then, make".
The objective part 1 is some text that varies. The objective part 1 is " an effort to move south. After that, attempt to head east. After that, retrieve the coin from the floor of the cookery. Alright, thanks!".
