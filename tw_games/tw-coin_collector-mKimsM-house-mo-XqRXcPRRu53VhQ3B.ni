...
Test quest0_0 with "go north / go east / go east / go east / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Hey, thanks for coming over to the TextWorld today, there is something I need you to do for me. First of all, head north. Then, attempt to go to the east. And then, attempt to go east. If you can get ".
The objective part 1 is some text that varies. The objective part 1 is "around to doing that, make an attempt to go to the east. Then, lift the coin from the floor of the steam room. And once you've done that, you win!".
