...
The r_1 and the r_0 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_14 and the r_2 and the r_8 and the r_9 are rooms.
...
The shower part 0 is some text that varies. The shower part 0 is "Ah, the shower. This is some kind of shower, really great standard vibes in this place, a wonderful standard atmosphere. You begin looking for stuff.
...
The steam room part 0 is some text that varies. The steam room part 0 is "You have entered a steam room. Not the steam room you'd expect. No, this is a steam room.
...
The studio part 0 is some text that varies. The studio part 0 is "I just think it's awesome that you're in a studio now. The room seems oddly familiar, as though it were only superficially different from the other rooms in the building.
...
The office part 0 is some text that varies. The office part 0 is "This office you have just entered is definitely usual.
...
The kitchenette part 0 is some text that varies. The kitchenette part 0 is "You find yourself in a kitchenette. An ordinary one. You start to take note of what's in the room.
...
The r_1 and the r_0 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_14 and the r_2 and the r_8 and the r_9 are rooms.
The r_1 and the r_0 and the r_11 and the r_10 and the r_13 and the r_12 and the r_3 and the r_4 and the r_5 and the r_7 and the r_6 and the r_14 and the r_2 and the r_8 and the r_9 are privately-named.
...
Test quest0_0 with "go east / go north / go north / go west / go west / go north / go east / go south / go south / go south / go east / go north / go east / go north / take coin"
...
The objective part 0 is some text that varies. The objective part 0 is "Who's got a virtual machine and is about to play through an fast paced round of TextWorld? You do! Here is how to play! First off, head east. Then, travel north. With that done, attempt to go to the n".
The objective part 1 is some text that varies. The objective part 1 is "orth. Then, take a trip west. And then, go to the west. Then, attempt to go to the north. Then, attempt to take a trip east. And then, head south. With that done, make an attempt to travel south. Afte".
The objective part 2 is some text that varies. The objective part 2 is "r that, make an attempt to go to the south. And then, go east. With that accomplished, travel north. With that accomplished, head east. Okay, and then, make an effort to head north. Okay, and then, re".
The objective part 3 is some text that varies. The objective part 3 is "cover the coin from the floor of the pantry. Got that? Good!".
